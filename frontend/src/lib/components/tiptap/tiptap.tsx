    ...
    <div className="w-full">
      <EditorProvider
        ...
        editorContainerProps={{
          className: cn(
            "max-w-none min-h-72 flex flex-col border border-zinc-900 prose prose-invert p-5 focus:outline-none rounded-b-md [.disabled]:rounded-t-md [.disabled]:text-text/50",
            { disabled: disabled },
          ),
        }}
        editable={!disabled}
