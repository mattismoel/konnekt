    ...
    >
      ...
      >
        <img
          ...
          alt={event.title}
          loading="lazy"
          className="h-full w-full scale-110 object-cover brightness-75 transition-all duration-200 group-hover:scale-100 group-hover:brightness-100 md:brightness-90"
        />
        ...
        <div
          className="pointer-events-none absolute h-72 w-72 -translate-x-1/2 -translate-y-1/2 scale-0 bg-white/50 mix-blend-overlay blur-3xl transition-transform duration-400 group-hover:scale-100"
          style={{
            left: `${mousePos.x}px`,
            top: `${mousePos.y}px`,
          }}
