...
function RouteComponent() {
  ...
  } = useSuspenseQuery(upcomingEventsQueryOpts(false));

  const {
    data: { records: previousEvents },
  } = useSuspenseQuery(previousEventsQueryOpts);
