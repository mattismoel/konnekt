<script lang="ts">
	...
	import SelectorEntry from '$lib/components/ui/SelectorEntry.svelte';
	...
	let { artist, selected, onSelect, onDeselect }: Props = $props();
</script>

<SelectorEntry {selected} {onSelect} {onDeselect}>
