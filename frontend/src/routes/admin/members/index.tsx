...
function RouteComponent() {
  ...
  const {
    data: { records: pendingMembers },
  } = useSuspenseQuery(pendingMembersQueryOpts);
    ...
    <div className="min-h-svh px-auto py-32">
      <AdminHeader>
        ...
        <AdminHeader.Description>
          Her kan du administrere alle medlemmer af foreningen, herunder deres
          roller i foreningen, og dermed deres tilladelser.
        </AdminHeader.Description>
      </AdminHeader>
