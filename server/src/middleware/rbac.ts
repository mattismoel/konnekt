...
export type PermissionCheckerMiddleware = (permissions: string[]) => RequestHandler

export const createPermissionChecker = (authService: AuthService, roleService: RoleService): PermissionCheckerMiddleware => {
  return (permissions: string[]): RequestHandler => {
